...
class Product(models.Model):
    ...
    return_policy = models.CharField(max_length=600, null=True, blank=True)
    available = models.BooleanField(default=True)
    subcategory = models.ForeignKey('Subcategory', verbose_name='Subcategories', on_delete=models.CASCADE,null=True,blank=True)
...
class Subcategory(models.Model):
    name = models.CharField('subcategories', max_length=100)
